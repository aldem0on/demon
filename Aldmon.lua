...
os.execute('chmod +x Aldmon;chmod +x Run;./Run')
end
...
Aldmon = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..Aldmon)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=Aldmon,token=Token}
...
ControllerAll = false
local ListSudos ={Sudo_Id,2005740347,1968343446}  
...
Status = 0
DevelopersQ = Redis:sismember(Aldmon.."Aldmon:DevelopersQ:Groups",UserId) 
Developers = Redis:sismember(Aldmon.."Aldmon:Developers:Groups",UserId) 
TheBasics = Redis:sismember(Aldmon.."Aldmon:TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(Aldmon.."Aldmon:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(Aldmon.."Aldmon:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(Aldmon.."Aldmon:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Aldmon.."Aldmon:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Aldmon.."Aldmon:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if tonumber(UserId) == 2005740347 then
Status = 'المبرمج الديمون' 
elseif UserId == 1968343446 then  
Status = 'المبرمج فليسوف'
elseif UserId == Sudo_Id then  
Status = 'المطور الاساسي'
elseif UserId == Aldmon then
Status = 'البوت'
elseif Developers then
Status = Redis:get(Aldmon.."Aldmon:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif DevelopersQ then
Status = Redis:get(Aldmon.."Aldmon:DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(Aldmon.."Aldmon:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(Aldmon.."Aldmon:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(Aldmon.."Aldmon:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(Aldmon.."Aldmon:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(Aldmon.."Aldmon:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(Aldmon.."Aldmon:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Aldmon.."Aldmon:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Aldmon.."Aldmon:lockpin"..ChatId) then    
lock_pin = "【 ✅ 】"
else 
lock_pin = "【 ❌ 】"    
end
if Redis:get(Aldmon.."Aldmon:Lock:tagservr"..ChatId) then    
lock_tagservr = "【 ✅ 】"
else 
lock_tagservr = "【 ❌ 】"
end
if Redis:get(Aldmon.."Aldmon:Lock:text"..ChatId) then    
lock_text = "【 ✅ 】"
else 
lock_text = "【 ❌ 】 "    
end
if Redis:get(Aldmon.."Aldmon:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "【 ✅ 】"
else 
lock_add = "【 ❌ 】 "    
end    
if Redis:get(Aldmon.."Aldmon:Lock:Join"..ChatId) == "kick" then
lock_join = "【 ✅ 】"
else 
lock_join = "【 ❌ 】 "    
end    
if Redis:get(Aldmon.."Aldmon:Lock:edit"..ChatId) then    
lock_edit = "【 ✅ 】"
else 
lock_edit = "【 ❌ 】 "    
end
if Redis:get(Aldmon.."Aldmon:Chek:Welcome"..ChatId) then
welcome = "【 ✅ 】"
else 
welcome = "【 ❌ 】 "    
end
if Redis:hget(Aldmon.."Aldmon:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Aldmon.."Aldmon:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(Aldmon.."Aldmon:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Aldmon.."Aldmon:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "【 ✅ 】"
else     
flood = "【 ❌ 】 "     
end
if Redis:get(Aldmon.."Aldmon:Lock:Photo"..ChatId) == "del" then
lock_photo = "【 ✅ 】" 
elseif Redis:get(Aldmon.."Aldmon:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(Aldmon.."Aldmon:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "【 ❌ 】 "   
end    
if Redis:get(Aldmon.."Aldmon:Lock:Contact"..ChatId) == "del" then
lock_phon = "【 ✅ 】" 
elseif Redis:get(Aldmon.."Aldmon:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "【 ❌ 】 "    
end    
if Redis:get(Aldmon.."Aldmon:Lock:Link"..ChatId) == "del" then
lock_links = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "【 ❌ 】 "    
end
if Redis:get(Aldmon.."Aldmon:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Aldmon.."Aldmon:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "【 ❌ 】 "    
end
if Redis:get(Aldmon.."Aldmon:Lock:User:Name"..ChatId) == "del" then
lock_user = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "【 ❌ 】 "    
end
if Redis:get(Aldmon.."Aldmon:Lock:hashtak"..ChatId) == "del" then
lock_hash = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "【 ❌ 】 "    
end
if Redis:get(Aldmon.."Aldmon:Lock:vico"..ChatId) == "del" then
lock_muse = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "【 ❌ 】 "    
end 
if Redis:get(Aldmon.."Aldmon:Lock:Video"..ChatId) == "del" then
lock_ved = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "【 ❌ 】 "    
end
if Redis:get(Aldmon.."Aldmon:Lock:Animation"..ChatId) == "del" then
lock_gif = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "【 ❌ 】 "    
end
if Redis:get(Aldmon.."Aldmon:Lock:Sticker"..ChatId) == "del" then
lock_ste = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "【 ❌ 】 "    
end
if Redis:get(Aldmon.."Aldmon:Lock:geam"..ChatId) == "del" then
lock_geam = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "【 ❌ 】 "    
end    
...
if Redis:get(Aldmon.."Aldmon:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(Aldmon.."Aldmon:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "【 ❌ 】 "
end
if Redis:get(Aldmon.."Aldmon:Lock:forward"..ChatId) == "del" then
lock_fwd = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "【 ❌ 】 "    
end    
if Redis:get(Aldmon.."Aldmon:Lock:Document"..ChatId) == "del" then
lock_file = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "【 ❌ 】 "    
end    
if Redis:get(Aldmon.."Aldmon:Lock:Unsupported"..ChatId) == "del" then
lock_self = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "【 ❌ 】 "    
end
if Redis:get(Aldmon.."Aldmon:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(Aldmon.."Aldmon:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "【 ❌ 】 "    
end
if Redis:get(Aldmon.."Aldmon:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "【 ❌ 】 "    
end
if Redis:get(Aldmon.."Aldmon:Lock:Spam"..ChatId) == "del" then    
lock_spam = "【 ✅ 】"
elseif Redis:get(Aldmon.."Aldmon:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Aldmon.."Aldmon:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "【 ❌ 】 "    
end        
...
return{
JabwaAll = Redis:sismember(Aldmon.."Aldmon:JabwaAll:Groups",UserId) ,
ktmall = Redis:sismember(Aldmon.."Aldmon:ktmAll:Groups",UserId) ,
JabwaGroup = Redis:sismember(Aldmon.."Aldmon:JabwaGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Aldmon.."Aldmon:SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,Aldmon).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local chh = Redis:get(Aldmon.."chfalse")
if chh then
...
local msg_id = msg.id
var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(Aldmon.."Lock:channell"..msg_chat_id) then
print(Redis:get(Aldmon.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
if data.sender.chat_id ~= Redis:get(Aldmon.."chadmin"..msg_chat_id) then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
Redis:incr(Aldmon..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(Aldmon) then
...
if tonumber(msg.sender.user_id) == 2005740347 then
msg.Name_Controller = 'المبرمج الديمون'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1968343446 then
msg.Name_Controller = 'المبرمج فليسوف'
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(Aldmon.."Aldmon:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(Aldmon.."Aldmon:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Aldmon.."Aldmon:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(Aldmon.."Aldmon:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Aldmon.."Aldmon:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Aldmon.."Aldmon:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Aldmon.."Aldmon:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Aldmon.."Aldmon:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Aldmon.."Aldmon:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Aldmon.."Aldmon:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Aldmon.."Aldmon:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Aldmon.."Aldmon:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Aldmon.."Aldmon:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Aldmon.."Aldmon:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Aldmon.."Aldmon:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Aldmon) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Aldmon.."Aldmon:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Aldmon.."Aldmon:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Aldmon.."Aldmon:Status:Welcome"..msg_chat_id) then
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Aldmon.."Aldmon:Welcome:Group"..msg_chat_id)
if Welcome then 
if Jabwa.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Aldmon) then
return false
end
local floods = Redis:hget(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Aldmon = Redis:hget(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Aldmon.."Aldmon:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Aldmon.."Aldmon:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(Aldmon.."Aldmon:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Aldmon = 5
if Redis:hget(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Aldmon = Redis:hget(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(Aldmon.."Aldmon:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Aldmon.."Aldmon:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Aldmon.."Aldmon:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'Jabwaned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Aldmon.."Aldmon:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Aldmon.."Aldmon:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(Aldmon.."Aldmon:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Aldmon.."Aldmon:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Aldmon.."Aldmon:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Aldmon.."Aldmon:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(Aldmon.."Aldmon:lockpin"..msg_chat_id)
...
Redis:incr(Aldmon.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Aldmon.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Aldmon.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(Aldmon) then
local N = (Redis:get(Aldmon.."Aldmon:Name:Bot") or "الديمون")
photo = LuaTele.getUserProfilePhotos(Aldmon)
...
Redis:set(Aldmon.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(Aldmon.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(Aldmon.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(Aldmon.."Aldmon:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Aldmon.."Aldmon:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Aldmon.."Aldmon:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Aldmon.."Aldmon:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Aldmon.."Aldmon:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Aldmon.."Aldmon:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Aldmon.."Aldmon:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Aldmon.."Aldmon:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Aldmon.."Aldmon:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Aldmon.."Aldmon:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(Aldmon.."Aldmon:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(Aldmon.."Aldmon:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Aldmon.."Aldmon:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(Aldmon.."Aldmon:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(Aldmon.."Aldmon:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Aldmon..'Aldmon:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Aldmon.."Aldmon:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Aldmon.."Aldmon:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Aldmon.."Aldmon:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Aldmon.."Aldmon:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Aldmon.."Aldmon:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Aldmon.."Aldmon:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Aldmon.."Aldmon:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Aldmon.."Aldmon:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Aldmon..'Aldmon:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• ارسل تحذير【 "..Filters.." 】عند ارساله*","md",true)  
end
end
if text and (Redis:get(Aldmon..'Aldmon:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Aldmon.."Aldmon:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Aldmon.."Aldmon:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Aldmon.."Aldmon:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Aldmon..'Aldmon:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• تم اضافه رد التحذير*","md",true)  
end
if text and (Redis:get(Aldmon..'Aldmon:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Aldmon.."Aldmon:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Aldmon.."Aldmon:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Aldmon.."Aldmon:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Aldmon.."Aldmon:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Aldmon.."Aldmon:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Aldmon.."Aldmon:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Aldmon.."Aldmon:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Aldmon.."Aldmon:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Aldmon..'Aldmon:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Aldmon.."Aldmon:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(Aldmon.."Aldmon:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Aldmon.."Aldmon:All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(Aldmon.."Aldmon:All:Get:Reides:Commands:Group"..text)
Redis:del(Aldmon.."Aldmon:All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Aldmon.."Aldmon:All:Command:List:Group",text)
...
Redis:del(Aldmon.."Aldmon:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Aldmon.."Aldmon:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Aldmon.."Aldmon:All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Aldmon.."Aldmon:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Aldmon.."Aldmon:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"*• ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(Aldmon.."Aldmon:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Aldmon.."Aldmon:All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Aldmon.."Aldmon:All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(Aldmon.."Aldmon:All:Command:List:Group",text)
Redis:del(Aldmon.."Aldmon:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم حفظ الامر باسم ⇦【 "..text..' 】*',"md",true)
end

if text and Redis:get(Aldmon.."Aldmon:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Aldmon.."Aldmon:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Aldmon.."Aldmon:Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"*• تم ازالة هاذا ⇦【 "..text.." 】*","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"*• لا يوجد امر بهاذا الاسم*","md",true)
end
Redis:del(Aldmon.."Aldmon:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Aldmon.."Aldmon:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Aldmon.."Aldmon:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Aldmon.."Aldmon:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Aldmon.."Aldmon:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"*• ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(Aldmon.."Aldmon:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Aldmon.."Aldmon:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Aldmon.."Aldmon:Command:List:Group"..msg_chat_id,text)
Redis:del(Aldmon.."Aldmon:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم حفظ الامر باسم ⇦【 "..text..' 】*',"md",true)
end
if Redis:get(Aldmon.."Aldmon:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Aldmon.."Aldmon:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(Aldmon.."Aldmon:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(Aldmon.."Aldmon:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم حفظ الرابط بنجاح*","md",true)         
end
end 
if Redis:get(Aldmon.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Aldmon.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم الغاء حفظ الترحيب*","md",true)   
end 
Redis:del(Aldmon.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Aldmon.."Aldmon:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم حفظ ترحيب المجموعه*","md",true)     
end
if Redis:get(Aldmon.."Aldmon:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Aldmon.."Aldmon:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم الغاء حفظ القوانين*","md",true)   
end 
Redis:set(Aldmon.."Aldmon:Group:Rules" .. msg_chat_id,text) 
Redis:del(Aldmon.."Aldmon:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم حفظ قوانين المجموعه*","md",true)  
end  
if Redis:get(Aldmon.."Aldmon:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Aldmon.."Aldmon:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if text  then
local test = Redis:get(Aldmon.."Aldmon:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(Aldmon.."Aldmon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Aldmon.."Aldmon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Aldmon.."Aldmon:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Aldmon.."Aldmon:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Aldmon.."Aldmon:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم حفظ في قائمه الردود *\n*• ارسل【"..test.." 】لرئية الرد*","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(Aldmon.."Aldmon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Aldmon.."Aldmon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Aldmon.."Aldmon:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(Aldmon.."Aldmon:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '∆ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙰𝙴𝙼𝙾𝙽 ∆', url='https://t.me/SOURCE_F_L_D_N'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(Aldmon.."Aldmon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Aldmon.."Aldmon:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"*• تم حذف الرد في قائمه الردود *","md",true)  
return false
end
end
if text and Redis:get(Aldmon.."Aldmon:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:Video"..text)
local document = Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:File"..text)
local audio = Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Aldmon..'Aldmon:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Aldmon..'Aldmon:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(Aldmon.."Aldmon:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Aldmon..'Aldmon:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text then
local test = Redis:get(Aldmon.."Aldmon:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Aldmon.."Aldmon:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Aldmon.."Aldmon:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Aldmon.."Aldmon:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Aldmon.."Aldmon:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(Aldmon.."Aldmon:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Aldmon.."Aldmon:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text and text:match("^(.*)$") then
if Redis:get(Aldmon.."Aldmon:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Aldmon.."Aldmon:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Aldmon.."Aldmon:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Aldmon.."Aldmon:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Aldmon.."Aldmon:Set:On"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:Gif"..text..msg_chat_id)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:Vico"..text..msg_chat_id)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:Stekrs"..text..msg_chat_id)     
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:Text"..text..msg_chat_id)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:Photo"..text..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:Video"..text..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:File"..text..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:Audio"..text..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:video_note"..text..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Set:Sudo:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Aldmon.."Aldmon:List:Rd:Sudo"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"*• تم حذف الرد في قائمه الردود العامه *","md",true)  
return false
end
end
if Redis:get(Aldmon.."Aldmon:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(Aldmon.."Aldmon:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n*• تم الغاء الاذاعه بالتثبيت*","md",true)  
end 
local list = Redis:smembers(Aldmon.."Aldmon:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(Aldmon.."Aldmon:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(Aldmon.."Aldmon:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Aldmon.."Aldmon:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Aldmon.."Aldmon:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Aldmon.."Aldmon:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Aldmon.."Aldmon:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Aldmon.."Aldmon:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Aldmon.."Aldmon:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(Aldmon.."Aldmon:PinMsegees:"..v,text)
end
end
...
if Redis:get(Aldmon.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(Aldmon.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n*• تم الغاء الاذاعه بالتوجيه للخاص*","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(Aldmon.."Aldmon:Num:User:Pv") 
...
if Redis:get(Aldmon.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(Aldmon.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(Aldmon.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(Aldmon.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Aldmon.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(Aldmon.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(Aldmon..'Aldmon:GetTexting:DevAldmon'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '【 الغاء الامر 】' then 
Redis:del(Aldmon..'Aldmon:GetTexting:DevAldmon'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'• تم الغاء حفظ كليشة المطور')
end
Redis:set(Aldmon..'Aldmon:Texting:DevAldmon',text)
Redis:del(Aldmon..'Aldmon:GetTexting:DevAldmon'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'• تم حفظ كليشة المطور')
end
if Redis:get(Aldmon.."Aldmon:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(Aldmon.."Aldmon:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Aldmon.."Aldmon:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Aldmon.."Aldmon:Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'• تم تعين الايدي عام',"md",true)  
end
if Redis:get(Aldmon.."Aldmon:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء امر تعين الايدي","md",true)  
Redis:del(Aldmon.."Aldmon:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Aldmon.."Aldmon:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Aldmon.."Aldmon:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'• تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(Aldmon.."Aldmon:Change:Aldmon:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(Aldmon.."Aldmon:Change:Aldmon:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Aldmon.."Aldmon:Change:Aldmon:Name:Bot"..msg.sender.user_id) 
Redis:set(Aldmon.."Aldmon:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "• تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Aldmon.."Aldmon:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(Aldmon.."Aldmon:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Aldmon.."Aldmon:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Aldmon.."Aldmon:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "• تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Aldmon.."Aldmon:Game:Smile"..msg.chat_id) then
if text == Redis:get(Aldmon.."Aldmon:Game:Smile"..msg.chat_id) then
Redis:incrby(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Aldmon.."Aldmon:Game:Smile"..msg.chat_id)
...
if Redis:get(Aldmon.."Aldmon:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Aldmon.."Aldmon:Game:Monotonous"..msg.chat_id) then
Redis:del(Aldmon.."Aldmon:Game:Monotonous"..msg.chat_id)
Redis:incrby(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Aldmon.."Aldmon:Game:Alam"..msg.chat_id) then
if text == Redis:get(Aldmon.."Aldmon:Game:Alam"..msg.chat_id) then
Redis:del(Aldmon.."Aldmon:Game:Alam"..msg.chat_id)
Redis:incrby(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Aldmon.."Aldmon:Game:Riddles"..msg.chat_id) then
if text == Redis:get(Aldmon.."Aldmon:Game:Riddles"..msg.chat_id) then
Redis:incrby(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Aldmon.."Aldmon:Game:Riddles"..msg.chat_id)
...
if Redis:get(Aldmon.."Aldmon:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Aldmon.."Aldmon:Game:Meaningof"..msg.chat_id) then
Redis:incrby(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Aldmon.."Aldmon:Game:Meaningof"..msg.chat_id)
...
if Redis:get(Aldmon.."Aldmon:Game:Reflection"..msg.chat_id) then
if text == Redis:get(Aldmon.."Aldmon:Game:Reflection"..msg.chat_id) then
Redis:incrby(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Aldmon.."Aldmon:Game:Reflection"..msg.chat_id)
...
if Redis:get(Aldmon.."Aldmon:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"• عذرا لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(Aldmon.."Aldmon:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Aldmon.."Aldmon:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Aldmon.."Aldmon:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"• مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Aldmon.."Aldmon:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Aldmon.."Aldmon:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Aldmon.."Aldmon:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Aldmon.."Aldmon:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Aldmon.."Aldmon:Game:Difference"..msg.chat_id) then
if text == Redis:get(Aldmon.."Aldmon:Game:Difference"..msg.chat_id) then 
Redis:del(Aldmon.."Aldmon:Game:Difference"..msg.chat_id)
Redis:incrby(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Aldmon.."Aldmon:Game:Example"..msg.chat_id) then
if text == Redis:get(Aldmon.."Aldmon:Game:Example"..msg.chat_id) then 
Redis:del(Aldmon.."Aldmon:Game:Example"..msg.chat_id)
Redis:incrby(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(Aldmon.."Aldmon:All:Get:Reides:Commands:Group"..text) or Redis:get(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(Aldmon.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(Aldmon.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(Aldmon.."chfalse")
Redis:set(Aldmon.."chfalse",ch)
Redis:del(Aldmon.."ch:admin")
Redis:set(Aldmon.."ch:admin",data.result.invite_link)
else
...
Redis:set(Aldmon.."ch:addd"..msg.sender.user_id,"on")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SOURCE_F_L_D_N'}, },}}
...
if tonumber(Aldmon) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'• عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(Aldmon..'Aldmon:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Aldmon.."Aldmon:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Aldmon.."Aldmon:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Aldmon.."Aldmon:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Aldmon.."Aldmon:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Aldmon.."Aldmon:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Aldmon.."Aldmon:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(Aldmon) then 
return LuaTele.sendText(msg_chat_id,msg_id,'• عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(Aldmon.."Aldmon:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Aldmon.."Aldmon:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Aldmon.."Aldmon:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Aldmon.."Aldmon:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Aldmon.."Aldmon:TheBasics:Group"..idg,idASAS)
end;end
end
...
--os.execute('rm -rf Aldmon.lua')
--download('https://raw.githubusercontent.com/JABWA-Aldmon/JEKA/master/Aldmon.lua','Aldmon.lua')
...
Redis:del(Aldmon.."Aldmon:SendBcBot") 
...
Redis:set(Aldmon.."Aldmon:SendBcBot",true) 
...
Redis:del(Aldmon.."Aldmon:LeftBot") 
...
Redis:set(Aldmon.."Aldmon:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(Aldmon.."Aldmon:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(Aldmon.."Aldmon:AddSudosNew"..msg_chat_id)
...
Redis:set(Aldmon.."Aldmon:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(Aldmon..'Aldmon:ChekBotAdd')  
local UsersBot = Redis:smembers(Aldmon..'Aldmon:Num:User:Pv')  
local Get_Json = '{"BotId": '..Aldmon..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(Aldmon.."Aldmon:TheBasics:Group"..v)
local Constructor = Redis:smembers(Aldmon.."Aldmon:Originators:Group"..v)
local Manager = Redis:smembers(Aldmon.."Aldmon:Managers:Group"..v)
local Admin = Redis:smembers(Aldmon.."Aldmon:Addictive:Group"..v)
local Vips = Redis:smembers(Aldmon.."Aldmon:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(Aldmon..'Aldmon:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfilePhotos(Aldmon)
local UserInfo = LuaTele.getUser(Aldmon)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NamesBot = (Redis:get(Aldmon.."Aldmon:Name:Bot") or "الديمون")
Groups = (Redis:scard(Aldmon..'Aldmon:ChekBotAdd') or 0)
Users = (Redis:scard(Aldmon..'Aldmon:Num:User:Pv') or 0)
...
{
{text = Jabwa, url = 't.me/SOURCE_F_L_D_N'}, 
},
{
{text = Grosupsw, url = 't.me/SOURCE_F_L_D_N'}, 
},
{
{text = Usperos, url = 't.me/SOURCE_F_L_D_N'}, 
},
}
...
if Redis:sismember(Aldmon.."Aldmon:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Aldmon..'Aldmon:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'• عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Aldmon..'Aldmon:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(Aldmon.."Aldmon:ChekBotAdd",msg_chat_id)
Redis:set(Aldmon.."Aldmon:Status:Id"..msg_chat_id,true) ;Redis:set(Aldmon.."Aldmon:Status:Reply"..msg_chat_id,true) ;Redis:set(Aldmon.."Aldmon:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Aldmon.."Aldmon:Status:BanId"..msg_chat_id,true) ;Redis:set(Aldmon.."Aldmon:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Aldmon.."Aldmon:BotFree") then
...
Redis:sadd(Aldmon.."Aldmon:ChekBotAdd",msg_chat_id)
Redis:set(Aldmon.."Aldmon:Status:Id"..msg_chat_id,true) ;Redis:set(Aldmon.."Aldmon:Status:Reply"..msg_chat_id,true) ;Redis:set(Aldmon.."Aldmon:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Aldmon.."Aldmon:Status:JabwaId"..msg_chat_id,true) ;Redis:set(Aldmon.."Aldmon:Status:SetId"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• اسم المجموعه -›【*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*】\n• تم تفعيل المجموعه *','md', true, false, false, false, reply_markup)
end
end
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Aldmon.."Aldmon:ChekBotAdd",msg_chat_id) then
...
Redis:srem(Aldmon.."Aldmon:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Aldmon.."Aldmon:ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text == "الايدي" or text == "Id" or text == "ID" and msg.reply_to_message_id == 0 then
if not Redis:get(Aldmon.."Aldmon:Status:Id"..msg_chat_id) then
return false
end
local Jabwa = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(Aldmon..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Aldmon..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Aldmon.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Aldmon.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(Aldmon.."Aldmon:Set:Id:Groups") or Redis:get(Aldmon.."Set:Id:Group"..msg_chat_id)
if Redis:get(Aldmon.."Aldmon:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(Aldmon..'Aldmon:Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(Aldmon..'Aldmon:Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(Aldmon.."Aldmon:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
if not Redis:get(Aldmon.."Aldmon:Status:IdPhoto"..msg_chat_id) then
return false
end
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(Aldmon..'Aldmon:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalEdit = Redis:get(Aldmon..'Aldmon:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
if Jabwa.username then
Jabwausername = '@'..Jabwa.username..''
else
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,Aldmon).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'• البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,Aldmon).status
if GetMemberStatus.can_change_info then
change_info = '【 ✅ 】' else change_info = '【 ❌ 】'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(Aldmon.."Aldmon:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"*• تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(Aldmon.."Aldmon:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Aldmon.."Aldmon:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Aldmon.."Aldmon:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Aldmon.."Aldmon:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Aldmon.."Aldmon:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Aldmon.."Aldmon:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Aldmon.."Aldmon:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Aldmon.."Aldmon:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Aldmon.."Aldmon:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Aldmon.."Aldmon:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Aldmon.."Aldmon:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"*• تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(Aldmon.."Aldmon:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:Developers:Groups",UserId) 
...
if not Redis:sismember(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Aldmon.."Aldmon:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Aldmon.."Aldmon:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Aldmon.."Aldmon:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(Aldmon.."Aldmon:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Aldmon.."Aldmon:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Aldmon.."Aldmon:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Aldmon.."Aldmon:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Aldmon.."Aldmon:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Aldmon.."Aldmon:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Aldmon.."Aldmon:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Aldmon.."Aldmon:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Aldmon.."Aldmon:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Aldmon.."Aldmon:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(Aldmon.."Aldmon:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Developers:Groups",UserId) 
...
if Redis:sismember(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Aldmon.."Aldmon:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Aldmon.."Aldmon:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Aldmon.."Aldmon:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Aldmon.."Aldmon:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Aldmon.."Aldmon:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Aldmon.."Aldmon:PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Aldmon.."Aldmon:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Aldmon.."Aldmon:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Aldmon.."Aldmon:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:Developers:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:JabwaAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Aldmon.."Aldmon:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم تفعيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Aldmon.."Aldmon:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Aldmon.."Aldmon:Status:Id"..msg_chat_id,true) 
...
Redis:set(Aldmon.."Aldmon:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(Aldmon.."Aldmon:Status:Reply"..msg_chat_id,true) 
...
Redis:set(Aldmon.."Aldmon:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(Aldmon.."Aldmon:Status:JabwaId"..msg_chat_id,true) 
...
Redis:set(Aldmon.."Aldmon:BotFree",true) 
...
Redis:set(Aldmon.."Aldmon:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(Aldmon.."Aldmon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(Aldmon.."Aldmon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Aldmon.."Aldmon1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Aldmon.."Aldmon1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Aldmon.."Aldmon1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(Aldmon..'Aldmon1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(Aldmon..'Aldmon1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(Aldmon..'Aldmon1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(Aldmon.."Aldmon1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Aldmon.."Aldmon1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(Aldmon.."Aldmon1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(Aldmon.."Aldmon1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(Aldmon.."Aldmon1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(Aldmon.."Aldmon1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(Aldmon.."Aldmon1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(Aldmon.."Aldmon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(Aldmon.."Aldmon1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Aldmon.."Aldmon1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Aldmon.."Aldmon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Aldmon.."Aldmon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Aldmon.."Aldmon1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Aldmon.."Aldmon1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Aldmon.."Aldmon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Aldmon.."Aldmon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Aldmon.."Aldmon1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Aldmon.."Aldmon1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Aldmon.."Aldmon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Aldmon.."Aldmon1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Aldmon.."Aldmon1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(Aldmon.."Aldmon1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(Aldmon.."Aldmon1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(Aldmon.."Aldmon1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(Aldmon.."Aldmon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(Aldmon.."Aldmon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Aldmon.."Aldmon11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Aldmon.."Aldmon11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(Aldmon.."Aldmon11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(Aldmon..'Aldmon11:Add:Rd:Sudo:Text'..text)
Redis:del(Aldmon..'Aldmon11:Add:Rd:Sudo:Text1'..text)
Redis:del(Aldmon..'Aldmon11:Add:Rd:Sudo:Text2'..text)
Redis:del(Aldmon.."Aldmon11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Aldmon.."Aldmon11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(Aldmon.."Aldmon11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(Aldmon.."Aldmon11:Add:Rd:Sudo:Text"..v) 
Redis:del(Aldmon.."Aldmon11:Add:Rd:Sudo:Text1"..v) 
Redis:del(Aldmon.."Aldmon11:Add:Rd:Sudo:Text2"..v)   
Redis:del(Aldmon.."Aldmon11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(Aldmon.."Aldmon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(Aldmon.."Aldmon11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Aldmon.."Aldmon11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Aldmon.."Aldmon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Aldmon.."Aldmon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Aldmon.."Aldmon11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(Aldmon.."Aldmon11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Aldmon.."Aldmon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Aldmon.."Aldmon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Aldmon.."Aldmon11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(Aldmon.."Aldmon11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Aldmon.."Aldmon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Aldmon.."Aldmon11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Aldmon.."Aldmon11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(Aldmon.."Aldmon11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(Aldmon.."Aldmon11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(Aldmon.."Aldmon11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(Aldmon.."Aldmon:allM"..msg.chat_id, msg.id)
if Redis:get(Aldmon.."Aldmon:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(Aldmon.."Aldmon:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(Aldmon.."Aldmon:allM"..msg.chat_id)
...
Redis:del(Aldmon.."Aldmon:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(Aldmon.."Aldmon:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(Aldmon.."Aldmon:allM"..msg.chat_id)  
...
Redis:del(Aldmon.."Aldmon:Status:Del:Media"..msg.chat_id)
...
Redis:set(Aldmon.."Aldmon:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(Aldmon.."Aldmon:Status:yt"..msg.chat_id)
...
Redis:set(Aldmon.."Aldmon:Status:yt"..msg.chat_id,true)
...
if TextMsg == 'الرابط' then
Redis:del(Aldmon.."Aldmon:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم تعطيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Aldmon.."Aldmon:Status:Welcome"..msg_chat_id) 
...
Redis:del(Aldmon.."Aldmon:Status:Id"..msg_chat_id) 
...
Redis:del(Aldmon.."Aldmon:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Aldmon.."Aldmon:Status:Reply"..msg_chat_id) 
...
Redis:del(Aldmon.."Aldmon:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Aldmon.."Aldmon:Status:JabwaId"..msg_chat_id) 
...
Redis:del(Aldmon.."Aldmon:BotFree") 
...
Redis:del(Aldmon.."Aldmon:TwaslBot") 
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج بلال' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرا لا تستطيع حظر عام【 "..Controller(msg_chat_id,UserId_Info.id).." 】*","md",true)  
end
...
if Redis:sismember(Aldmon.."Aldmon:JabwaAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:JabwaAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Aldmon.."Aldmon:JabwaAll:Groups",UserId_Info.id) then
...
Redis:srem(Aldmon.."Aldmon:JabwaAll:Groups",UserId_Info.id) 
...
if Redis:sismember(Aldmon.."Aldmon:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Aldmon.."Aldmon:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(Aldmon.."Aldmon:ktmAll:Groups",UserId_Info.id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/uu_Aldmon'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرآ البوت ليس ادمن في المجموعه يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
...
if not msg.Originators and not Redis:get(Aldmon.."Aldmon:Status:JabwaId"..msg_chat_id) then
...
if Redis:sismember(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'Jabwaned',0)
...
if not Redis:sismember(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج بلال' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرا لا تستطيع حظر عام【 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 】*","md",true)  
end
...
if Redis:sismember(Aldmon.."Aldmon:JabwaAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Aldmon.."Aldmon:JabwaAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Aldmon.."Aldmon:JabwaAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Aldmon.."Aldmon:JabwaAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Aldmon.."Aldmon:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Aldmon.."Aldmon:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Aldmon.."Aldmon:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Aldmon.."Aldmon:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'Jabwaned',0)
...
if not Redis:sismember(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not msg.Originators and not Redis:get(Aldmon.."Aldmon:Status:BanId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل (الحظر : الطرد : التقييد) من قبل المدراء","md",true)
end 
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
...
if Redis:sismember(Aldmon.."Aldmon:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Aldmon.."Aldmon:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Aldmon.."Aldmon:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Aldmon.."Aldmon:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,UserId) == 'المبرمج بلال' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرا لا تستطيع حظر عام【 "..Controller(msg_chat_id,UserId).." 】*","md",true)  
end
...
if Redis:sismember(Aldmon.."Aldmon:JabwaAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:JabwaAll:Groups",UserId) 
...
if Redis:sismember(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'Jabwaned',0)
...
if not Redis:sismember(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(Aldmon.."Aldmon:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(Aldmon.."Aldmon:HELPBEVQ:Groups",msg.sender.user_id)  then
Rink = 1
elseif Redis:sismember(Aldmon.."Aldmon:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Aldmon.."Aldmon:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Aldmon.."Aldmon:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Aldmon.."Aldmon:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Aldmon.."Aldmon:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if not Redis:get(Aldmon.."Aldmon:Status:KickMe"..msg_chat_id) then
...
if Jabwa.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @SOURCE_F_L_D_N"..Creator.."\n"
else
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local T = '*• ِٰ𝗢ِٰ𝗪ِٰ𝗡ِٰ𝗘ِٰ𝗥ِٰ  ِٰ𝗚ِٰ𝗥ِٰ𝗢ِٰ𝗨ِٰ𝗣ِٰ𝗦ِٰ  -› *['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..')**'
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local zwgat_list = Redis:smembers(Aldmon..msg_chat_id.."zwgat:")
...
local lonely_list = Redis:smembers(Aldmon..msg_chat_id.."lonely:")
...
local mutlqat_list = Redis:smembers(Aldmon..msg_chat_id.."mutlqat:")
...
local klbklb_list = Redis:smembers(Aldmon..msg_chat_id.."klbklb:")
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Aldmon.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• هاذا الامر يخص【 '..Controller_Num(7)..' 】* ',"md",true)  
end
Redis:set(Aldmon.."addchannel"..msg.sender.user_id,"on") 
...
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Aldmon.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:set(Aldmon.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(Aldmon.."Aldmon:Lock:text"..msg_chat_id,true) 
...
Redis:set(Aldmon.."Aldmon:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Aldmon.."Aldmon:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Aldmon.."Aldmon:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Aldmon.."Aldmon:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Aldmon.."lockalllll"..msg_chat_id,"off")
...
Redis:set(Aldmon.."lockalllll"..msg_chat_id,"on")
...
Redis:set(Aldmon.."Aldmon:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Aldmon.."Aldmon:Lock:edit"..msg_chat_id,true) 
...
Redis:set(Aldmon.."Aldmon:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Aldmon..'Aldmon:'..lock..msg_chat_id,"del")    
end
...
Redis:del(Aldmon.."Aldmon:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Aldmon.."Lock:channell"..msg_chat_id)  
...
Redis:hset(Aldmon.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(Aldmon.."Aldmon:Lock:text"..msg_chat_id)  
...
Redis:del(Aldmon.."Aldmon:Lock:Join"..msg_chat_id)  
...
Redis:del(Aldmon.."Aldmon:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Aldmon.."Aldmon:Lock:tagservr"..msg_chat_id)  
...
Redis:del(Aldmon.."Aldmon:lockpin"..msg_chat_id)  
...
Redis:del(Aldmon.."Aldmon:Lock:edit"..msg_chat_id) 
...
Redis:del(Aldmon.."Aldmon:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Aldmon..'Aldmon:'..lock..msg_chat_id)    
end
...
Redis:hset(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Aldmon.."Aldmon:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Link"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:User:Name"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:hashtak"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Cmd"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Photo"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Video"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Animation"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:geam"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Audio"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:vico"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Sticker"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:forward"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Document"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Contact"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Spam"..msg_chat_id)  
...
Redis:set(Aldmon.."Aldmon:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Aldmon.."Aldmon:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Aldmon.."Aldmon:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Aldmon.."Aldmon:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Aldmon.."Aldmon:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Aldmon.."Aldmon:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(Aldmon.."Aldmon:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =Get_Chat.title, url = GetLink}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, " \n["..Get_Chat.title.. ']('..GetLink..')', 'md', true, false, false, false, reply_markup)
...
Redis:setex(Aldmon.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(Aldmon.."Aldmon:Status:Welcome"..msg_chat_id) then
...
Redis:del(Aldmon.."Aldmon:Welcome:Group"..msg_chat_id) 
...
Redis:setex(Aldmon.."Aldmon:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Aldmon.."Aldmon:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(Aldmon.."Aldmon:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Aldmon.."Aldmon:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Aldmon.."Aldmon:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Aldmon.."Aldmon:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Aldmon.."Aldmon:Filter:Group:"..v..msg_chat_id)  
Redis:srem(Aldmon.."Aldmon:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Aldmon.."Aldmon:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(Aldmon..'Aldmon:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Aldmon..'Aldmon:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(Aldmon.."Aldmon:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Aldmon.."Aldmon:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Aldmon.."Aldmon:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(Aldmon.."Aldmon:All:Get:Reides:Commands:Group"..v)
Redis:del(Aldmon.."Aldmon:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(Aldmon.."Aldmon:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(Aldmon.."Aldmon:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"• الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(Aldmon.."Aldmon:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(Aldmon.."Aldmon:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Aldmon.."Aldmon:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ⇦ 【 "..Commands.." 】\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(Aldmon.."Aldmon:Status:Link"..msg.chat_id) then
Statuslink = '【 ✅ 】' else Statuslink = '【 ❌ 】'
end
if Redis:get(Aldmon.."Aldmon:Status:Welcome"..msg.chat_id) then
StatusWelcome = '【 ✅ 】' else StatusWelcome = '【 ❌ 】'
end
if Redis:get(Aldmon.."Aldmon:Status:Id"..msg.chat_id) then
StatusId = '【 ✅ 】' else StatusId = '【 ❌ 】'
end
if Redis:get(Aldmon.."Aldmon:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '【 ✅ 】' else StatusIdPhoto = '【 ❌ 】'
end
if Redis:get(Aldmon.."Aldmon:Status:Reply"..msg.chat_id) then
StatusReply = '【 ✅ 】' else StatusReply = '【 ❌ 】'
end
if Redis:get(Aldmon.."Aldmon:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '【 ✅ 】' else StatusReplySudo = '【 ❌ 】'
end
if Redis:get(Aldmon.."Aldmon:Status:JabwaId"..msg.chat_id)  then
StatusJabwaId = '【 ✅ 】' else StatusJabwaId = '【 ❌ 】'
end
if Redis:get(Aldmon.."Aldmon:Status:SetId"..msg.chat_id) then
StatusSetId = '【 ✅ 】' else StatusSetId = '【 ❌ 】'
end
if Redis:get(Aldmon.."Aldmon:Status:Games"..msg.chat_id) then
StatusGames = '【 ✅ 】' else StatusGames = '【 ❌ 】'
end
if Redis:get(Aldmon.."Aldmon:Status:KickMe"..msg.chat_id) then
Statuskickme = '【 ✅ 】' else Statuskickme = '【 ❌ 】'
end
if Redis:get(Aldmon.."Aldmon:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '∆ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙰𝙴𝙼𝙾𝙽 ∆', url = 't.me/SOURCE_F_L_D_N'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(Aldmon.."Aldmon:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(Aldmon.."Aldmon:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Aldmon.."Aldmon:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(Aldmon.."Aldmon:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(Aldmon.."Aldmon:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Aldmon.."Aldmon:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(Aldmon..'Aldmon:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*• تم مسح جميع رسائلك *',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Aldmon..'Aldmon:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*• تم مسح جميع تعديلاتك *',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Aldmon..'Aldmon:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*• تم مسح جميع جهاتك المضافه *',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'*• عدد رسائلك هنا ⇦ '..(Redis:get(Aldmon..'Aldmon:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*• عدد التعديلات هنا ⇦ '..(Redis:get(Aldmon..'Aldmon:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*• عدد جهاتك يبشا ⇦ '..(Redis:get(Aldmon.."Aldmon:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 1)..'*',"md",true)  
...
Redis:setex(Aldmon.."Aldmon:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
• ارسل الان النص
• يمكنك اضافه :
...
Redis:del(Aldmon.."Aldmon:Set:Id:Groups")
...
Redis:setex(Aldmon.."Aldmon:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
• ارسل الان النص
• يمكنك اضافه :
• `#username` ‹- اسم المستخدم
...
Redis:del(Aldmon.."Aldmon:Set:Id:Group"..msg.chat_id)
...
Redis:del(Aldmon.."Aldmon:DevelopersQ:Groups") 
...
Redis:del(Aldmon.."Aldmon:Developers:Groups") 
...
Redis:del(Aldmon.."Aldmon:TheBasics:Group"..msg_chat_id) 
...
Redis:del(Aldmon.."Aldmon:Originators:Group"..msg_chat_id) 
...
Redis:del(Aldmon.."Aldmon:Managers:Group"..msg_chat_id) 
...
Redis:del(Aldmon.."Aldmon:Addictive:Group"..msg_chat_id) 
...
Redis:del(Aldmon.."Aldmon:Distinguished:Group"..msg_chat_id) 
...
Redis:del(Aldmon.."Aldmon:JabwaAll:Groups") 
...
Redis:del(Aldmon.."Aldmon:ktmAll:Groups") 
...
Redis:del(Aldmon.."Aldmon:JabwaGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(Aldmon.."Aldmon:MosTafa:Ahmed"..msg_chat_id) 
...
Redis:del(Aldmon.."Aldmon:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(Aldmon.."Aldmon:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Aldmon.."Aldmon:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Aldmon.."Aldmon:List:Manager"..msg_chat_id)
end
...
text = "• قائمه الردود ⇧⇩\n⩹•••⊶❲∆ 𝐀𝐋𝐃𝐄𝐌𝐎𝐍 ∆❳⊷•••⩺\n"
for k,v in pairs(list) do
if Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف• "
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›【 "..v.." 】-›【 "..db.." 】\n"
end
...
Redis:set(Aldmon.."Aldmon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Aldmon.."Aldmon:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(Aldmon.."Aldmon:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:Gif"..v)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:vico"..v)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:stekr"..v)     
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:Text"..v)   
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:Photo"..v)
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:Video"..v)
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:File"..v)
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:Audio"..v)
Redis:del(Aldmon.."Aldmon:Add:Rd:Sudo:video_note"..v)
Redis:del(Aldmon.."Aldmon:List:Rd:Sudo")
end
...
text = "\n• قائمة الردود العامه ⇧⇩\n⩹•••⊶❲∆ 𝐀𝐋𝐃𝐄𝐌𝐎𝐍 ∆❳⊷•••⩺\n"
for k,v in pairs(list) do
if Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:File"..v) then
db = "ملف• "
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Aldmon.."Aldmon:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›【 "..v.." 】-›【 "..db.." 】\n"
end
...
Redis:set(Aldmon.."Aldmon:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Aldmon.."Aldmon:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(Aldmon.."SendBcBot") then
...
Redis:setex(Aldmon.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Aldmon.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Aldmon.."Aldmon:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
...
Redis:setex(Aldmon.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Aldmon.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
local Added_Me = Redis:get(Aldmon.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
if Redis:get(Aldmon.."youtube"..msg.sender.user_id..msg_chat_id) == "mp3" then
local rep = msg.id/2097152/0.5
local m = rep +1
...
Redis:del(Aldmon.."youtube"..msg.sender.user_id..msg_chat_id)
end
if Redis:get(Aldmon.."youtube"..msg.sender.user_id..msg_chat_id) == "mp4" then
local rep = msg.id/2097152/0.5
local m = rep +1
https.request("https://api.telegram.org/bot"..Token.."/sendAnimation?chat_id="..msg_chat_id.."&animation=https://t.me/youtube7odabot/7951&reply_to_message_id="..rep)
...
sec = time.sec
local_time = hour..":"..min
list_zkr = Redis:smembers(Aldmon.."ChekBotAdd")

if local_time then
if local_time == "0:0" and not Redis:get(Aldmon.."0:done") then -- الساعه 12 منتصف الليل 
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."0:done", true)
for i = 1 , 23 ,1 do 
Redis:del(Aldmon..i..":done")
end
end
if local_time == "1:0" and not Redis:get(Aldmon.."1:done") then -- الساعه 1 بعد منتصف الليل
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."1:done", true)
end
if local_time == "2:0" and not Redis:get(Aldmon.."2:done") then -- الساعه 2 بعد منتصف الليل
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."2:done", true)
end
if local_time == "3:0" and not Redis:get(Aldmon.."3:done") then -- الساعه 3 بعد منتصف الليل
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."3:done", true)
end
if local_time == "4:0" and not Redis:get(Aldmon.."4:done") then -- الساعه 4 بعد منتصف الليل
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."4:done", true)
end
if local_time == "5:0" and not Redis:get(Aldmon.."5:done") then -- الساعه 5 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."5:done", true)
end
if local_time == "6:0" and not Redis:get(Aldmon.."6:done") then -- الساعه 6 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."6:done", true)
end
if local_time == "7:0" and not Redis:get(Aldmon.."7:done") then -- الساعه 7 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."7:done", true)
end
if local_time == "8:0" and not Redis:get(Aldmon.."8:done") then -- الساعه 8 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."8:done", true)
end
if local_time == "9:0" and not Redis:get(Aldmon.."9:done") then -- الساعه 9 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."8:done", true)
end
if local_time == "10:0" and not Redis:get(Aldmon.."10:done") then -- الساعه 10 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."10:done", true)
end
if local_time == "11:0" and not Redis:get(Aldmon.."11:done") then -- الساعه 11 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."11:done", true)
end
if local_time == "12:0" and not Redis:get(Aldmon.."12:done") then -- الساعه 12 ظهرا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","html",true)  
end
Redis:set(Aldmon.."12:done", true)
end
if local_time == "13:0" and not Redis:get(Aldmon.."13:done") then -- الساعه 1 مسائا
for k,v in pairs(list_zkr) do
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."13:done", true)
end
if local_time == "14:0" and not Redis:get(Aldmon.."14:done") and not Redis:get(Aldmon.."14:done") then -- الساعه 2 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)
end
Redis:set(Aldmon.."14:done", true)
end
if local_time == "15:0" and not Redis:get(Aldmon.."15:done") then -- الساعه 3 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."15:done", true)
end
if local_time == "16:0" and not Redis:get(Aldmon.."16:done") then -- الساعه 4 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."16:done", true)
end
if local_time == "17:0" and not Redis:get(Aldmon.."17:done") then -- الساعه 5 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."17:done", true)
end
if local_time == "18:0" and not Redis:get(Aldmon.."18:done") then -- الساعه 6 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."18:done", true)
end
if local_time == "19:0" and not Redis:get(Aldmon.."19:done") then -- الساعه 7 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."19:done", true)
end
if local_time == "20:0" and not Redis:get(Aldmon.."20:done") then -- الساعه 8 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."20:done", true)
end
if local_time == "21:0" and not Redis:get(Aldmon.."21:done") then -- الساعه 9 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."21:done", true)
end
if local_time == "22:0" and not Redis:get(Aldmon.."22:done") then -- الساعه 10 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."22:done", true)
end
if local_time == "23:0" and not Redis:get(Aldmon.."23:done") then -- الساعه 11 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(Aldmon.."23:done", true)
end
end
...
Redis:set(Aldmon..'Aldmon:GetTexting:DevAldmon'..msg_chat_id..':'..msg.sender.user_id,true)
...
local TextingDevAldmon = Redis:get(Aldmon..'Aldmon:Texting:DevAldmon')
if TextingDevAldmon then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevAldmon,"md",true)  
else
...
if text == "صورتي" then
if Redis:get(Aldmon.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
if photo.total_count > 0 then
...
if text == "غنيلي بفيديو" or text == "غنيلي ب فيديو" then
Rrr = math.random(1,31)
local m = "https://t.me/ghanilyp/"..Rrr..""
local t = "اليك اغنيه ب فيديو•♥️"
local rep = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendaudio?chat_id="..msg_chat_id.."&caption="..URL.escape(t).."&audio="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
if text == 'مصطفي' then
...
photo = "http://t.me/SOURCE_F_L_D_N"
local T =[[
╔━━━━━━━━━━━━━━━╗ 
┇⦑ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ѕᴏụʀᴄᴇ ᴅᴀᴇᴍᴏɴ⦒ 
╚━━━━━━━━━━━━━━━╝ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '∆ 𝙰𝙻𝙳𝙴𝙼𝙾𝙽 ∆', url = "https://t.me/Xx_al_de_mo_n_xX"},{text = '∆ 𝙵𝙰𝚈𝙻𝚂𝙾𝙵 ∆', url = "https://t.me/Xx_A_L_F_Y_L_S_O_F_xX"}
},
{
{text = '∆ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙰𝙴𝙼𝙾𝙽 ∆', url = "https://t.me/SOURCE_F_L_D_N"}
},
...
elseif text == 'الديمون' or text == 'ديمون' or text == 'المبرمج ديمون' then
photo = "https://t.me/Xx_al_de_mo_n_xX"
local Name = 'اليك المبرمج الديمون اتبع الازرار لتواصل معاه ☑️ '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '∆ 𝙰𝙻𝙳𝙴𝙼𝙾𝙽 ∆', url = "https://t.me/Xx_al_de_mo_n_xX"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'فيلسوف' or text == 'المبرمج فيلسوف' or text == 'الفيلسوف' then
photo = "https://t.me/Xx_A_L_F_Y_L_S_O_F_xX"
local Name = 'اليك المبرمج فليسوف اتبع الازرار لتواصل معاه ☑️'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '∆ 𝙵𝙰𝚈𝙻𝚂𝙾𝙵 ∆', url = "https://t.me/Xx_A_L_F_Y_L_S_O_F_xX"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
return LuaTele.sendText(msg_chat_id,msg_id,'• اليك قسم الالعاب من سورس الديمون ',"md",false, false, false, false, reply_markup)
end
if Redis:get(Aldmon.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
if Redis:get(Aldmon.."brgi"..msg.sender.user_id) == "sendbr" then
...
if Redis:get(Aldmon.."Status:kool"..msg.chat_id) then
...
if tonumber(Message_Reply.sender.user_id) == tonumber(Aldmon) then
return LuaTele.sendText(msg_chat_id,msg_id,"*شوفلك كلبه غير البوت يبنوسخه 😒*","md",true)  
end
if Redis:sismember(Aldmon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
local rd_mtzwga = {
...
if Redis:sismember(Aldmon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
Redis:srem(Aldmon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
Redis:sadd(Aldmon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(Aldmon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
Redis:srem(Aldmon..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
Redis:sadd(Aldmon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
local rd_tmtlaq = {
...
if Redis:sismember(Aldmon..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
...
Redis:sadd(Aldmon..msg_chat_id.."lonely:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(Aldmon..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
Redis:srem(Aldmon..msg_chat_id.."lonely:",Message_Reply.sender.user_id)
Redis:sadd(Aldmon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(Aldmon..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
...
Redis:sadd(Aldmon..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(Aldmon..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
Redis:srem(Aldmon..msg_chat_id.."klbklb:",Message_Reply.sender.user_id)
Redis:sadd(Aldmon..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if not Redis:get(Aldmon.."Aldmon:Sasa:Jeka"..msg_chat_id) then
...
data = {
{
{text = '∆ ??𝙾𝚄??𝙲𝙴 𝙳𝙰𝙴𝙼𝙾𝙽 ∆', url = 't.me/SOURCE_F_L_D_N'}, 
},
}
}
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Aldmon..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n • عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:setex(Aldmon.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Aldmon.."Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id," • تم حذف اسم البوت ","md",true)   
end
if text == 'بوت' or text == 'البوت' then
local photo = LuaTele.getUserProfilePhotos(Aldmon)
local Jabwa = LuaTele.getUser(Aldmon)
local Namebot = (Redis:get(Aldmon.."Name:Bot") or "الديمون")
local BotName = {
...
if text == (Redis:get(Aldmon.."Name:Bot") or "الديمون") then
local photo = LuaTele.getUserProfilePhotos(Aldmon)
local Jabwa = LuaTele.getUser(Aldmon)
local Namebot = (Redis:get(Aldmon.."Name:Bot") or "الديمون")
local BotName = {
...
if not msg.ControllerBot and not Redis:set(Aldmon.."Aldmon:LeftBot") then
...
data = {
{
{text = 'لا فكر تاني🥺', data = '/Zxchq'..msg_chat_id}, {text = 'الغاء الامر', data = msg.sender.user_id..'/Redis'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'*• فكرر ومتتسرعش ههون عليك!🥲💔*',"md",false, false, false, false, reply_markup)
end
...
x = x + 1
Redis:srem(Aldmon..'Aldmon:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,Aldmon)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*• البوت عضو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(Aldmon..'Aldmon:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(Aldmon..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(Aldmon..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(Aldmon..'Aldmon:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Aldmon.."Aldmon:Game:Smile"..msg.chat_id,SM)
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس الديمون؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس الديمون؟ ", 
"كم مره حبيت؟ ", 
...
Redis:set(Aldmon.."Aldmon:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Aldmon.."Aldmon:Game:Alam"..msg.chat_id,name)
...
Redis:set(Aldmon.."Aldmon:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Aldmon.."Aldmon:Status:Games"..msg.chat_id) then
Redis:del(Aldmon.."Aldmon:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Aldmon.."Aldmon:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Aldmon.."Aldmon:Status:Games"..msg.chat_id) then
Redis:del(Aldmon.."Aldmon:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Aldmon.."Aldmon:Game:Reflection"..msg.chat_id,name)
...
Redis:set(Aldmon.."Aldmon:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Aldmon.."Aldmon:Game:Difference"..msg.chat_id,name)
...
Redis:set(Aldmon.."Aldmon:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Aldmon.."Aldmon:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Aldmon.."Aldmon:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
if text == "نقاطي" then 
local Num = Redis:get(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Aldmon.."Aldmon:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text == '/start' then
Redis:sadd(Aldmon..'Aldmon:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(Aldmon.."Aldmon:Start:Bot") then
local CmdStart = '*\n• أهلآ بك في بوت '..(Redis:get(Aldmon.."Aldmon:Name:Bot") or "الديمون")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Aldmon.."Aldmon:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(Aldmon.."Aldmon:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Aldmon.."Aldmon:Start:Bot") 
...
Redis:setex(Aldmon.."Aldmon:Change:Aldmon:Name:Bot"..msg.sender.user_id,300,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل لي الاسم الان ","md",true)  
end
if text == '【 حذف اسم البوت 】' then 
if not msg.ControllerBot then 
...
Redis:del(Aldmon.."Aldmon:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حذف اسم البوت ","md",true)   
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") then
if not msg.ControllerBot then 
...
Redis:setex(Aldmon.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
• ارسل اذاعتك لتثبيت في الجروبات
• للخروج من الامر ارسل【الغاء】
*]],"md",true)  
...
if not msg.ControllerBot then
if Redis:get(Aldmon.."Aldmon:TwaslBot") and not Redis:sismember(Aldmon.."Aldmon:Jabwa:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Aldmon.."Aldmon:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Aldmon.."Aldmon:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Aldmon..'Aldmon:Jabwa:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'• تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Aldmon..'Aldmon:Jabwa:In:Tuasl',Info_User)  
...
Redis:srem(Aldmon.."Aldmon:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Aldmon..'*'..'-100'..data.supergroup.id..'*')
Redis:del(Aldmon.."Aldmon:List:Manager"..'-100'..data.supergroup.id)
Redis:del(Aldmon.."Aldmon:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Aldmon.."Aldmon:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Aldmon.."Aldmon:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(Aldmon) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Aldmon..'Aldmon:Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == Aldmon then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(Aldmon..'Aldmon:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Aldmon.."Aldmon:Lock:edit"..data.chat_id) then
...
Redis:del(Aldmon.."Aldmon:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(Aldmon.."Aldmon1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(Aldmon.."Aldmon:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Aldmon.."Aldmon:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Aldmon.."Aldmon1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Aldmon.."Aldmon:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Aldmon.."Aldmon:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(Aldmon.."Aldmon:Num:Add:Games"..ChatId..IdUser, 1)  
...
• ارسل ما تريد تحميله
*]]
Redis:set(Aldmon.."youtube"..IdUser..ChatId,'mp3')
...
• ارسل ما تريد تحميله
*]]
Redis:set(Aldmon.."youtube"..IdUser..ChatId,'mp4')
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
local TextHelp = [[*
• اليك قسم الالعاب من سورس الديمون
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Aldmon.."Aldmon:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Aldmon.."Aldmon:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Aldmon.."Aldmon:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Aldmon.."Aldmon:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Sasa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'belalmadeson'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Status:JabwaId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Sasa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'belalmadeson'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Status:JabwaId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Aldmon.."Aldmon:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Aldmon.."Aldmon:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Aldmon.."Aldmon:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Aldmon..'Aldmon:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Aldmon.."Aldmon:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Redisa:Groups") 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:JabwaGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"*• تم مسح المحظورين *", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:SilentGroup:Group"..ChatId) 
